...
export interface ISalesQuotationToSalesParams {
    id?: number,  date: string, invoice_no: number,   qty: number, amount: number, total_due: number, user_name: string, tier: string, remarks: string,customer: string, pending_due: number, payment: number;
}
