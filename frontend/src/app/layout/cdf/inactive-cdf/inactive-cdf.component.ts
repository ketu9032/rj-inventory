...
@Component({
    selector: 'app-inactive-cdf',
    templateUrl: './inactive-cdf.component.html',
    styleUrls: ['./inactive-cdf.component.scss']
})
export class inactiveCdfComponent implements OnInit {
